 ...
 */
public class ReceivePushAndDontAbortActivity extends AppCompatActivity {
    ...
    private void dispatchNotification() {
        Intent intent = new Intent(ReceivePushAndDontAbortActivity.this, PushReceiverIntentService.class);
        Notification notification = new Notification("ReceivePushAndDontAbortActivity Notification", "This notification was received in ReceivePushAndDontAbortActivity");
    ...
    protected void onStart() {
        super.onStart();
        registerPushReceiver(ReceivePushAndDontAbortActivity.this, receiver);
    }
